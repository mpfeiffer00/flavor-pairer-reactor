...
public class FlavorBibleExtractor {
	...
	public static void main(String[] args) throws IOException {
		...
		new FlavorBibleExtractor().manipulatePdfOriginal(DEST);
	}
	...
	public void manipulatePdfOriginal(String dest) throws IOException {
		...
		final LocationTextExtractionStrategy extractionStrategy = listener
				.attachEventListener(new LocationTextExtractionStrategy(), new MovieFilter(rect));
...
//		}
	...
	private static final class MovieFilter extends TextRegionEventFilter {
		public MovieFilter(Rectangle filterRect) {
			super(filterRect);
		}
